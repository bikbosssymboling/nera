...
import {
    FaCheckSquare, FaUserCog, FaPlay, FaFileImport, FaFileExcel
    , FaDollarSign, FaHistory, FaSave, FaPlus, FaTrash, FaArrowCircleUp
    , FaArrowCircleDown, FaCopy, FaMapMarkerAlt
} from "react-icons/fa";
...
export default function PlanYExclusiveDetail() {
    ...
    return (
        <>
            <div>
                {/* Project Information */}
                <div className="w-full bg-white p-6 rounded-lg shadow-lg mb-6" id="project-info">
                    {/* Header */}
                ...
                <div className="bg-white  p-6 w-full rounded-lg shadow-lg mx-auto">
                    ...
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="flex gap-2">
                            {[
                                { icon: FaCheckSquare, text: "Request Approve", color: "bg-green-500", onClick: () => console.log("Request Approve button clicked") },
                                { icon: FaUserCog, text: "Position/KPI", color: "bg-fuchsia-500", onClick: () => setShowPositionModal(true) },
                                { icon: FaPlay, text: "PlanY Start", color: "bg-violet-500", onClick: () => console.log("start")},
                                { icon: FaFileImport, text: "Import PlanY", color: "bg-sky-500", onClick: () => console.log("Import PlanY button clicked") },
                                { icon: FaFileExcel, text: "Template", color: "bg-amber-500", onClick: () => console.log("Template button clicked") },
                                { icon: FaDollarSign, text: "To Pay", color: "bg-yellow-500", onClick: () => console.log("To Pay button clicked") },
                                { icon: FaHistory, text: "History", color: "bg-blue-500", onClick: () => setShowHistoryModal(true)},
                            ].map((btn, index) => (
                                <button
                                    key={index}
                    ...
                    {/* Table Container */}
                    <div id="work-schedule-container" className="w-full  grid grid-cols-1 overflow-x-auto">
                        ...
                        <div className="flex justify-start my-2 sticky left-0">
            ...
            <SetPositionModal isOpen={showPositionModal} onClose={() => setShowPositionModal(false)} />
